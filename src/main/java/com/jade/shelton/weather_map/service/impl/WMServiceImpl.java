...
public class WMServiceImpl implements WMService{
	...
	public void testingThings() throws ApiException, InterruptedException, IOException, JSONException {
	    ...
	    //System.out.println("result" + result.routes[0].legs[0].endAddress.toString());

	    //System.out.println("heyh ey there " + result.routes[0].legs[0].steps[0].duration.inSeconds);
