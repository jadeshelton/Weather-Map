...
public class WeatherConditions implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -4918345068195075423L;
	private String url = "";
	 ...
	 * 
	 * @param apiKey
	 *            The valid API key to gain access to the REST API
	 */
	public WeatherConditions(String apiKey) {
	 ...
	 */
	public WeatherConditions setParameters(String location) {
