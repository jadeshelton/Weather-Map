...
public class WeatherForecast implements Serializable {
	...
	private static final long serialVersionUID = 2673933879914797204L;
	 ...
	 * 
	 * @return The WeatherConditions object with parameters set
	 */
	public WeatherForecast setParameters(String location) {
	...
	public void downloadData() {
	 ...
	 String jObjString = result.toString();
	...
	// obsElev =
	// jObj.getJSONObject("observation_location").getString("elevation");
	// obsCtry =
	// jObj.getJSONObject("observation_location").getString("country");
	// obsCity = jObj.getJSONObject("observation_location").getString("city");
	// obsLat =
	// jObj.getJSONObject("observation_location").getString("latitude");
	// obsLon =
	// jObj.getJSONObject("observation_location").getString("longitude");
	...
	// dispState =
	// jObj.getJSONObject("display_location").getString("state_name");
	...
	// // throw new
	// //
	// BadRequestException(result.getJSONObject("response").getJSONObject("error").getString("description"));
	// // case "querynotfound":
	// // case "invalidquery":
	// // throw new
	// //
	// DataNotSetException(result.getJSONObject("response").getJSONObject("error").getString("description"));
	// // case "keynotfound":
	...
	//
	// } else {
	// System.out.println("API Error: " + result.toString());
	// }
